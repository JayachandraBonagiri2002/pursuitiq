    ...
    <div className="min-h-screen px-6 py-8 max-w-5xl mx-auto">
      ...
      <div className="card mb-8">
        ...
        <div
          ...
          className="border-2 border-dashed border-gray-700 hover:border-purple-500 rounded-xl py-8 text-center cursor-pointer transition-all"
        >
          {uploading ? (
            ...
            <>
              <p className="text-gray-300 font-medium">Drop proposal here (PDF, DOCX, PPTX)</p>
